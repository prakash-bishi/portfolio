...
Start here, then go to `AGENTS.md`.
...
**Do not** duplicate project specification here. **Do not** read every
Markdown file in the repo automatically — `AGENTS.md` explains the
